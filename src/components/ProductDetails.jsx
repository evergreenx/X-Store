...
export default function ProductDetails() {
  ...
  const fetchSingleProduct = async () => {
    let response = await axiosConfig.get(`products/${id}`);
...
<Header/>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded  border-gray-200" 
      src={productDetails.image} />
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">

        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1 truncate">{productDetails.title}</h1>
        <div class="flex mb-4">
          ...
          <span class="flex ml-3 pl-3 py-2 border-l-2 border-gray-200">
            ...
            <button class="ml-2 text-gray-500 hover:text-indigo-500">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
              </svg>
            </button>
            <button class="ml-2 text-gray-500 hover:text-red-600" href="#">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
